...
if(empty($result)){	
	Functions::alertaRedirect("Usu\u00e1rio incorreto ou n\u00e3o cadastrado!", "../../../index.html");	
}
...
if (Bcrypt::check($_POST['senha'], $result['senha'])){
	...
	Functions::redirect("../../main/consulta_estoque.php");
} else { // caso a senha esteja incorreta, e impressa uma mensagem do erro e o usuario e redirecionado
	Functions::alertaRedirect("Login ou senha incorretos. Tente Novamente.", "../../../index.html");
}
?>